...
function getRevertData(error) {
    ...
    error.walk((e)=>{
        const error = e;
        if (typeof error.data === 'string' || typeof error.data?.revertData === 'string' || !(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$base$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseError"]) && typeof error.message === 'string') {
...
async function prepareAuthorization(client, parameters) {
    ...
    if (typeof authorization.nonce === 'undefined') {
        ...
        if (executor === 'self' || executor?.address && (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$address$2f$isAddressEqual$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAddressEqual"])(executor.address, account.address)) authorization.nonce += 1;
    }
    ...
    return new Promise((resolve, reject)=>{
        const unobserve = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$observe$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["observe"])(observerId, {
            ...
            const unpoll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$poll$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["poll"])(async ()=>{
                if (retryCount && count >= retryCount) done(()=>emit.reject(new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$account$2d$abstraction$2f$errors$2f$userOperation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WaitForUserOperationReceiptTimeoutError"]({
                        hash
                    })));
                try {
            ...
            if (timeout) setTimeout(()=>done(()=>emit.reject(new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$account$2d$abstraction$2f$errors$2f$userOperation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WaitForUserOperationReceiptTimeoutError"]({
                        hash
                    }))), timeout);
            return unpoll;
        });
...
function parseSignature(signatureHex) {
    const { r, s } = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f40$noble$2f$curves$2f$esm$2f$secp256k1$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["secp256k1"].Signature.fromCompact(signatureHex.slice(2, 130));
...
//# sourceMappingURL=9e883_viem__esm_b0418f03._.js.map